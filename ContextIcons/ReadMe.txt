========================================================================
    ACTIVE TEMPLATE LIBRARY : ContextIcons Project Overview
========================================================================

AppWizard has created this ContextIcons project for you to use as the starting point for
writing your Dynamic Link Library (DLL).

This file contains a summary of what you will find in each of the files that
make up your project.

ContextIcons.vcxproj
    This is the main project file for VC++ projects generated using an Application Wizard.
    It contains information about the version of Visual C++ that generated the file, and
    information about the platforms, configurations, and project features selected with the
    Application Wizard.

ContextIcons.vcxproj.filters
...
ContextIcons.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (ContextIcons.h)
        GUID definitions                                (ContextIcons_i.c)
        A type library                                  (ContextIcons.tlb)
        Marshaling code                                 (ContextIcons_p.c and dlldata.c)

ContextIcons.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in ContextIcons.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named ContextIcons.pch and a precompiled types file named StdAfx.obj.
...
ContextIconsps.vcxproj
	...
	dlldata.c, ContextIcons_i.c and ContextIcons_p.c which are required
	to build the proxy/stub DLL.

ContextIconsps.vcxproj.filters
